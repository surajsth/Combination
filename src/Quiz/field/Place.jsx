...
import "../../App.css"
import PlaceData from './../Question/PlaceQ';
function Place() {
    ...
    const updateScore = () => {
        if (clickoption === PlaceData[current].correct) {
            setScore(score + 1);
        }
    }
    const resetAll = () => {
                    ...
                    <div className=" mt-5 p-4 w-50" id="quiz">
                        {showResult ? (
                            <>
                                ...
                                <h1 className='text-#27171a text-center'>Total Score: {PlaceData.length}</h1>
                            ...
                            <div className="quiz-header">
                                <h2 className='text-center text-white mt-5' id="question">{PlaceData[current].question}</h2>
                                <div className="container">
                                    {PlaceData[current].options.map((option, i) => {
                                        return (
                                            <button
